...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_NOTE_TABLE = "create table "
            ...
            + " time varchar(10), date varchar(10), content text, color integer, classify text, level integer, father text, path text, title text, soundpath text, ElapsedMillis text)";
    ...
    public DatabaseHelper(Context context) {
        super(context, COOLNOTE_DATABASE_NAME, null, 3);
    }
